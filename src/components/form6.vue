...
<!--    >-->
<!--      <template #header-npg>-->
<!--        <div style="min-width: 80px">1</div>-->
<!--        <div>2</div>-->
<!--      </template>-->
<!--      <template #npg="{row}">-->
...
<!--        <edit-table-cell v-bind="cell.props(row,cell, loadingMenu)"-->
<!--                         @component-action="saveValue($event)"></edit-table-cell>-->
<!--      </template>-->
...
export default {
  ...
  components: {NewTable, EditTableCell, GridTable},
  data() {
    return {
      serverData: [],
      loadingData: false,
